...
exports.GetMyInfo = undefined;

var _api = __webpack_require__(/*! ./api */ "./src/regUser/api/api.js");
...
/***/ "./src/regUser/api/getUrlArgObject.js":
/*!********************************************!*\
  !*** ./src/regUser/api/getUrlArgObject.js ***!
  \********************************************/
/*! no static exports found */
...
/***/ "./src/regUser/assets/img/logo.png":
/*!*****************************************!*\
  !*** ./src/regUser/assets/img/logo.png ***!
  \*****************************************/
/*! no static exports found */
...
/***/ "./src/regUser/component/infoPage.js":
/*!*******************************************!*\
  !*** ./src/regUser/component/infoPage.js ***!
  \*******************************************/
/*! no static exports found */
...
__webpack_require__(/*! antd-mobile/lib/toast/style/css */ "./node_modules/antd-mobile/lib/toast/style/css.js");
...
var _apiFn = __webpack_require__(/*! ../api/apiFn */ "./src/regUser/api/apiFn.js");

var _open = __webpack_require__(/*! ../api/open */ "./src/regUser/api/open.js");

var _open2 = _interopRequireDefault(_open);

var _api = __webpack_require__(/*! ../api/api */ "./src/regUser/api/api.js");

var _api2 = _interopRequireDefault(_api);

var _getUrlArgObject = __webpack_require__(/*! ../api/getUrlArgObject */ "./src/regUser/api/getUrlArgObject.js");
...
var _DSoftWorkWebpackFoolMultipleNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
  filename: "D:/soft-work/webpack-fool-multiple/src/regUser/component/infoPage.js",
...
var InfoPage = _wrapComponent("InfoPage")(function (_React$Component) {
  ...
  function InfoPage() {
    ...
    _this2.copyUrl = function () {
      _toast2.default.info('复制成功!', 1);
      var _this = _this2;
      (0, _copyToClipboard2.default)(_this2.state.data.invitationCode, {
        debug: true,
  ...
  _createClass(InfoPage, [{
    ...
    value: function componentWillMount() {
      ...
      var data = (0, _apiFn.GetMyInfo)(getParams.userId, getParams.optUserId, getParams.tokenId, function (data) {
        _this.setState({
    ...
    value: function render() {
      return _react3.default.createElement(
        ...
        _react3.default.createElement(
          "div",
          { className: "bg-box" },
          _react3.default.createElement("img", { className: "imgc", src: "" + _api2.default.imgPath + this.state.data.userPic, alt: "" }),
          _react3.default.createElement(
            "span",
            { className: "bgt" },
        ...
        _react3.default.createElement(
          "div",
          { className: "rwm-box" },
          _react3.default.createElement("img", { className: "rwm-img", src: "" + _api2.default.imgPath + this.state.data.userQR, alt: "" }),
          _react3.default.createElement(
            "span",
            { className: "rwm-bar" },
            "\u957F\u6309\u8BC6\u522B\u4E8C\u7EF4\u7801\uFF0C\u8F7B\u677E\u6CE8\u518C\u52A0\u5165"
        ...
        _react3.default.createElement(
          ...
          _react3.default.createElement("input", { className: "btnr", type: "text", defaultValue: this.state.data.invitationCode }),
          _react3.default.createElement(
            "div",
            { className: "redBtn" },
            _react3.default.createElement(
              "button",
              { className: "btncss am-button", onClick: this.copyUrl },
              "\u590D\u5236"
            )
          )
        ),
        _react3.default.createElement(
          ...
          _react3.default.createElement("img", { onClick: _open2.default.bind(this, path, getParams), src: __webpack_require__(/*! ../assets/img/logo.png */ "./src/regUser/assets/img/logo.png"), alt: "" })
        )
      );
    }
  }]);
