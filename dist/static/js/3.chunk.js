...
exports.getReserveGoodsDetail = undefined;

var _api = __webpack_require__(/*! ./api */ "./src/getReserve/api/api.js");
...
var getReserveGoodsDetail = exports.getReserveGoodsDetail = function getReserveGoodsDetail(reserveId, userId, callback) {
    _axios2.default.post(_api2.default.getReserveGoodsDetail, {
...
/***/ "./src/getReserve/api/getUrlArgObject.js":
/*!***********************************************!*\
  !*** ./src/getReserve/api/getUrlArgObject.js ***!
  \***********************************************/
/*! no static exports found */
...
/***/ "./src/getReserve/assets/img/jt.png":
/*!******************************************!*\
  !*** ./src/getReserve/assets/img/jt.png ***!
  \******************************************/
/*! no static exports found */
...
/***/ "./src/getReserve/assets/img/toTop.png":
/*!*********************************************!*\
  !*** ./src/getReserve/assets/img/toTop.png ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "./src/getReserve/component/infoPage.js":
/*!**********************************************!*\
  !*** ./src/getReserve/component/infoPage.js ***!
  \**********************************************/
/*! no static exports found */
...
var _apiFn = __webpack_require__(/*! ../api/apiFn */ "./src/getReserve/api/apiFn.js");

var _api = __webpack_require__(/*! ../api/api */ "./src/getReserve/api/api.js");

var _api2 = _interopRequireDefault(_api);

var _open = __webpack_require__(/*! ../api/open */ "./src/getReserve/api/open.js");

var _open2 = _interopRequireDefault(_open);

var _getUrlArgObject = __webpack_require__(/*! ../api/getUrlArgObject */ "./src/getReserve/api/getUrlArgObject.js");
...
var _DSoftWorkWebpackFoolMultipleNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
  filename: "D:/soft-work/webpack-fool-multiple/src/getReserve/component/infoPage.js",
...
var InfoPage = _wrapComponent("InfoPage")(function (_React$Component) {
  ...
  _createClass(InfoPage, [{
    ...
    value: function componentWillMount() {
      ...
      var data = (0, _apiFn.getReserveGoodsDetail)(getParams.reserveId, getParams.userId, function (data) {
        console.log(data);
        var imgArr = [];
        var infoImgArr = [];
      ...
      return _react3.default.createElement(
        ...
        _react3.default.createElement(
          ...
          _react3.default.createElement(
            ...
            this.state.dataImg.length > 0 && this.state.dataImg.map(function (val) {
              return _react3.default.createElement(
                "a",
                {
                  key: val,
        ...
        _react3.default.createElement(
          ...
          _react3.default.createElement(
            ...
            _react3.default.createElement(
              ...
              ",\u7ACB\u7701\uFFE5",
              this.state.data.mPrice - this.state.data.reservePrice - this.state.data.finalPrice,
              "\uFF0C\u5DF2\u8BA2",
        ...
        _react3.default.createElement(
          ...
          _react3.default.createElement(
            "div",
            { className: this.state.data.statusCode != 1 ? "cantClickBtn" : "redBtn" },
            _react3.default.createElement(
              _button2.default,
              { type: "primary", onClick: _open2.default.bind(this, path, getParams), disabled: this.state.data.statusCode != 1 ? true : false, className: "btncss" },
              this.state.data.statusCode != 1 ? "活动已结束" : "立即预定"
            )
          )
        ),
        _react3.default.createElement(
          ...
          _react3.default.createElement("img", { src: __webpack_require__(/*! ../assets/img/toTop.png */ "./src/getReserve/assets/img/toTop.png"), alt: "" })
        ),
        _react3.default.createElement(
          "div",
          ...
          _react3.default.createElement("img", { src: __webpack_require__(/*! ../assets/img/jt.png */ "./src/getReserve/assets/img/jt.png"), alt: "" })
        )
      );
    }
  }]);
