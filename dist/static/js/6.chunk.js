...
/***/ "./src/getGrouponDetail/api/api.js":
/*!*****************************************!*\
  !*** ./src/getGrouponDetail/api/api.js ***!
  \*****************************************/
...
/***/ "./src/getGrouponDetail/api/apiFn.js":
/*!*******************************************!*\
  !*** ./src/getGrouponDetail/api/apiFn.js ***!
  \*******************************************/
/*! no static exports found */
...
exports.getGrouponDetail = undefined;

var _api = __webpack_require__(/*! ./api */ "./src/getGrouponDetail/api/api.js");
...
var getGrouponDetail = exports.getGrouponDetail = function getGrouponDetail(goodsId, userId, activityId, callback) {
...
/***/ "./src/getGrouponDetail/api/getUrlArgObject.js":
/*!*****************************************************!*\
  !*** ./src/getGrouponDetail/api/getUrlArgObject.js ***!
  \*****************************************************/
/*! no static exports found */
...
/***/ "./src/getGrouponDetail/api/open.js":
/*!******************************************!*\
  !*** ./src/getGrouponDetail/api/open.js ***!
  \******************************************/
/*! no static exports found */
...
/***/ "./src/getGrouponDetail/assets/img/jt.png":
/*!************************************************!*\
  !*** ./src/getGrouponDetail/assets/img/jt.png ***!
  \************************************************/
/*! no static exports found */
...
/***/ "./src/getGrouponDetail/assets/img/toTop.png":
/*!***************************************************!*\
  !*** ./src/getGrouponDetail/assets/img/toTop.png ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./src/getGrouponDetail/component/infoPage.js":
/*!****************************************************!*\
  !*** ./src/getGrouponDetail/component/infoPage.js ***!
  \****************************************************/
/*! no static exports found */
...
var _apiFn = __webpack_require__(/*! ../api/apiFn */ "./src/getGrouponDetail/api/apiFn.js");

var _api = __webpack_require__(/*! ../api/api */ "./src/getGrouponDetail/api/api.js");

var _api2 = _interopRequireDefault(_api);

var _open = __webpack_require__(/*! ../api/open */ "./src/getGrouponDetail/api/open.js");

var _open2 = _interopRequireDefault(_open);

var _getUrlArgObject = __webpack_require__(/*! ../api/getUrlArgObject */ "./src/getGrouponDetail/api/getUrlArgObject.js");
...
var _DSoftWorkWebpackFoolMultipleNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
  filename: "D:/soft-work/webpack-fool-multiple/src/getGrouponDetail/component/infoPage.js",
...
var InfoPage = _wrapComponent("InfoPage")(function (_React$Component) {
  ...
  function InfoPage() {
    ...
    _this2.openFn = function () {
      (0, _open2.default)(path, getParams);
    };
  ...
  _createClass(InfoPage, [{
    ...
    value: function componentWillMount() {
      var _this = this;
      var data = (0, _apiFn.getGrouponDetail)(getParams.goodsId, getParams.userId, getParams.activityId, function (data) {
        console.log(data);
        var imgArr = [];
        var infoImgArr = [];
    ...
    value: function render() {
      ...
      if (nowTime) {
        btn = _react3.default.createElement(
          ...
          _react3.default.createElement(
            "div",
            { className: "yewBtn", onClick: this.openFn },
            _react3.default.createElement(
              _button2.default,
              { type: "primary", className: "btncss" },
              _react3.default.createElement(
                "span",
                null,
                "\uFFE549.9"
          ...
          _react3.default.createElement(
            "div",
            { className: "redBtn", onClick: this.openFn },
            _react3.default.createElement(
              _button2.default,
              { type: "primary", className: "btncss" },
              _react3.default.createElement(
        ...
        btn = _react3.default.createElement(
          ...
          _react3.default.createElement(
            "div",
            { className: "cantClickBtn" },
            _react3.default.createElement(
              _button2.default,
              { type: "primary", disabled: true, className: "btncss" },
              "\u6D3B\u52A8\u5DF2\u7ECF\u7ED3\u675F"
            )
          )
        );
      ...
      return _react3.default.createElement(
        ...
        _react3.default.createElement(
          ...
          _react3.default.createElement(
            ...
            _react3.default.createElement(
              ...
              "\uFFE5",
              this.state.data.memberPrice
            ),
            _react3.default.createElement(
              "span",
              { className: "oldPrice" },
              "\uFFE5",
              this.state.data.salePrice
            ),
            _react3.default.createElement(
              "span",
              { className: "jfInfo" },
            ...
            _react3.default.createElement(
              ...
              { className: "ptnum" },
              "\u5DF2\u62FC",
              this.state.data.saleNumber,
              "\u4EF6-",
              this.state.data.memberCount,
              "\u4EBA\u62FC\u56E2"
            )
          ),
          _react3.default.createElement(
        ...
        _react3.default.createElement(
          ...
          _react3.default.createElement(
            "div",
            { className: "orderTitle", onClick: this.openFn },
            _react3.default.createElement(
              "span",
              { className: "titleText" },
              num,
            ...
            this.state.data.grouponOpenDTOList && this.state.data.grouponOpenDTOList.map(function (val, index) {
              return _react3.default.createElement(
                ...
                _react3.default.createElement(
                  "div",
                  { className: "lf" },
                  _react3.default.createElement("img", { src: _api2.default.imgPath + val.userPic, alt: "" }),
                  _react3.default.createElement(
                    "span",
                    { className: "name" },
                    val.nickName
                ...
                _react3.default.createElement(
                  "div",
                  { className: "rbtn redBtn" },
                  _react3.default.createElement(
                    _button2.default,
                    { type: "primary", className: "", onClick: this.openFn },
                    "\u53BB\u62FC\u56E2"
                  )
                ),
                _react3.default.createElement(
                  ...
                  _react3.default.createElement(
                    ...
                    { className: "title" },
                    "\u8FD8\u5DEE",
                    this.state.data.memberCount - val.joinCount,
                    "\u4EBA\u62FC\u6210"
                  ),
                  _react3.default.createElement(
                    "span",
                    { className: "time" },
                    "\u5269\u4F59",
                    val.serverDateTime - val.expireDateTime
                  )
                )
              );
            })
        ...
        _react3.default.createElement(
          "div",
          { className: "pageFoot sBtn" },
          btn
        ),
        _react3.default.createElement(
          "div",
          { className: this.state.isScroll ? "gotoTop showView" : "gotoTop hiddenView", onClick: this.gotoTop },
          _react3.default.createElement("img", { src: __webpack_require__(/*! ../assets/img/toTop.png */ "./src/getGrouponDetail/assets/img/toTop.png"), alt: "" })
        ),
        _react3.default.createElement(
          "div",
          ...
          _react3.default.createElement("img", { src: __webpack_require__(/*! ../assets/img/jt.png */ "./src/getGrouponDetail/assets/img/jt.png"), alt: "" })
        )
      );
    }
  }]);
