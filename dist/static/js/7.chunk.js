...
/***/ "./src/getGoodsDetail/api/apiFn.js":
/*!*****************************************!*\
  !*** ./src/getGoodsDetail/api/apiFn.js ***!
  \*****************************************/
/*! no static exports found */
...
var _api = __webpack_require__(/*! ./api */ "./src/getGoodsDetail/api/api.js");
...
/***/ "./src/getGoodsDetail/api/getUrlArgObject.js":
/*!***************************************************!*\
  !*** ./src/getGoodsDetail/api/getUrlArgObject.js ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./src/getGoodsDetail/api/open.js":
/*!****************************************!*\
  !*** ./src/getGoodsDetail/api/open.js ***!
  \****************************************/
/*! no static exports found */
...
/***/ "./src/getGoodsDetail/assets/img/jt.png":
/*!**********************************************!*\
  !*** ./src/getGoodsDetail/assets/img/jt.png ***!
  \**********************************************/
/*! no static exports found */
...
/***/ "./src/getGoodsDetail/assets/img/toTop.png":
/*!*************************************************!*\
  !*** ./src/getGoodsDetail/assets/img/toTop.png ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./src/getGoodsDetail/component/infoPage.js":
/*!**************************************************!*\
  !*** ./src/getGoodsDetail/component/infoPage.js ***!
  \**************************************************/
/*! no static exports found */
...
var _apiFn = __webpack_require__(/*! ../api/apiFn */ "./src/getGoodsDetail/api/apiFn.js");

var _api = __webpack_require__(/*! ../api/api */ "./src/getGoodsDetail/api/api.js");

var _api2 = _interopRequireDefault(_api);

var _open = __webpack_require__(/*! ../api/open */ "./src/getGoodsDetail/api/open.js");

var _open2 = _interopRequireDefault(_open);

var _getUrlArgObject = __webpack_require__(/*! ../api/getUrlArgObject */ "./src/getGoodsDetail/api/getUrlArgObject.js");
...
var _DSoftWorkWebpackFoolMultipleNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
  filename: "D:/soft-work/webpack-fool-multiple/src/getGoodsDetail/component/infoPage.js",
...
var InfoPage = _wrapComponent("InfoPage")(function (_React$Component) {
  ...
  _createClass(InfoPage, [{
    ...
    value: function componentWillMount() {
      var _this = this;
      var data = (0, _apiFn.GetCardInfo)(getParams.goodsId, getParams.userId, function (data) {
        console.log(data);
        var imgArr = [];
        var infoImgArr = [];
    ...
    value: function render() {
      return _react3.default.createElement(
        ...
        _react3.default.createElement(
          ...
          _react3.default.createElement(
            "div",
            { className: this.state.data.statusCode == 1 ? "redBtn" : "cantClickBtn" },
            _react3.default.createElement(
              _button2.default,
              { onClick: _open2.default.bind(this, path, getParams), type: "primary", disabled: this.state.data.statusCode == 1 ? false : true, className: "btncss" },
              "\u52A0\u5165\u8D2D\u7269\u8F66"
            )
          )
        ),
        _react3.default.createElement(
          "div",
          { className: "toastBox", style: { display: this.state.data.statusCode == 2 ? "block" : "none" } },
          _react3.default.createElement(
            "span",
            null,
            "\u6765\u665A\u4E86\uFF0C\u5546\u54C1\u5DF2\u7ECF\u4E0B\u67B6\u5566~"
        ...
        _react3.default.createElement(
          ...
          _react3.default.createElement("img", { src: __webpack_require__(/*! ../assets/img/toTop.png */ "./src/getGoodsDetail/assets/img/toTop.png"), alt: "" })
        ),
        _react3.default.createElement(
          "div",
          ...
          _react3.default.createElement("img", { src: __webpack_require__(/*! ../assets/img/jt.png */ "./src/getGoodsDetail/assets/img/jt.png"), alt: "" })
        )
      );
    }
  }]);
