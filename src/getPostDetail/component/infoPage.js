    ...
    return (
      <div className="card-page">
        ...
        <div className="pageFoot">
          <div onClick={open.bind(this,path,getParams)}  className={this.state.data.statusCode == 0 ? "cantClickBtn" : "redBtn"}>
            <Button type="primary" disabled={this.state.data.statusCode == 0 ? true : false} className="btncss">加入购物车</Button>
          </div>
        </div>
        <div className="toastBox" style={{ display: this.state.data.statusCode == 0 ? "block" : "none" }}>
