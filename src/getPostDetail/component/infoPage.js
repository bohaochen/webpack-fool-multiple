  ...
  render() {
    ...
    return (
      <div className="card-page">
        ...
        {
          this.state.data.discoverVideo!=null?
          <video controls src={API.imgPath+this.state.data.discoverVideo}></video>
          :
          <img src={API.imgPath+this.state.data.discoverPic} alt="" />
        }
          <div className="textC">
            <div className="title">
            ...
            <div className="title-info">
              <img src={this.state.data.userPic?API.imgPath+this.state.data.userPic:require("../../common/assets/img/de.jpg")} alt="" />
              <span className="user-name">
            {this.state.data.nickName}
            </span>
              <span className="see-num">
            {this.state.data.visitNumber}次浏览
            </span>
            </div>
            <div className="editC">
              ...
              this.state.data.goodsList.map((val,index)=>{
                return(
                  ...
                  <Button type="primary" className="btncss" onClick={open.bind(this,path,getParams,this)}>
                    <img src={require("../../common/assets/img/carIcon.png")} alt=""/>
                  </Button>
                </div>
                  </div>
                </div>
