      ...
      <div className="card-page">
        ...
        <div className="pageFoot">
          <div className={this.state.data.statusCode!=1 ? "cantClickBtn" : "redBtn"}>
            <Button type="primary"  onClick={open.bind(this,path,getParams)} disabled={this.state.data.statusCode!=1 ? true : false} className="btncss">{this.state.data.statusCode!=1 ? "活动已结束" : "立即预定"}</Button>
          </div>
        </div>
